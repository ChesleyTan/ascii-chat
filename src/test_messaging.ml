 ...
 *)
let tests = [
    "np/nt/user1/package1/test1"  >:: (fun _ -> assert_string "user1@10:  " 
        (Messaging.refresh_history_buffer user1 package1;
        Messaging.chat_history_to_string ()));
    "op/ot/user1/package1/test2"  >:: (fun _ -> assert_string "user1@10:  " 
        (Messaging.refresh_history_buffer user1 package1;
        Messaging.chat_history_to_string ()));
    "np/nt/user1/package2/test3"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna" 
        (Messaging.refresh_history_buffer user1 package2;
        Messaging.chat_history_to_string ()));
    "op/ot/user1/package2/test4"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna" 
        (Messaging.refresh_history_buffer user1 package2;
        Messaging.chat_history_to_string ()));
    "np/ot/user1/package3/test5"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna" 
        (Messaging.refresh_history_buffer user1 package3;
        Messaging.chat_history_to_string ()));
    "op/ot/user1/package3/test6"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna" 
        (Messaging.refresh_history_buffer user1 package3;
        Messaging.chat_history_to_string ()));
    "np/nt/user1/package4/test7"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna" 
        (Messaging.refresh_history_buffer user1 package4;
        Messaging.chat_history_to_string ()));
    "np/nt/user3/package5/test8"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis" 
        (Messaging.refresh_history_buffer user3 package5;
        Messaging.chat_history_to_string ()));
    "np/nt/user2/package6/test9"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis" 
        (Messaging.refresh_history_buffer user2 package6;
        Messaging.chat_history_to_string ()));
    "np/nt/user1/package7/test10"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;" 
        (Messaging.refresh_history_buffer user1 package7;
        Messaging.chat_history_to_string ()));
    "np/ot/user3/package7/test11"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;" 
        (Messaging.refresh_history_buffer user3 package7;
        Messaging.chat_history_to_string ()));
    "op/ot/user1/package7/test12"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;" 
        (Messaging.refresh_history_buffer user1 package7;
        Messaging.chat_history_to_string ()));
    "np/nt/user1/package8/test13"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis" 
        (Messaging.refresh_history_buffer user1 package8;
        Messaging.chat_history_to_string ()));
    "np/ot/user2/package9/test14"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis" 
        (Messaging.refresh_history_buffer user3 package9;
        Messaging.chat_history_to_string ()));
    "np/nt/user3/package9/test15"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis\nuser2@20: nunc obdurat" 
        (Messaging.refresh_history_buffer user2 package9;
        Messaging.chat_history_to_string ()));
    "op/ot/user3/package9/test16"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis\nuser2@20: nunc obdurat" 
        (Messaging.refresh_history_buffer user2 package9;
        Messaging.chat_history_to_string ()));
    "np/nt/user3/package9/test17"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis\nuser2@20: nunc obdurat\nuser1@10: et tunc curat" 
        (Messaging.refresh_history_buffer user1 package10;
        Messaging.chat_history_to_string ()));
    "op/ot/user3/package9/test18"  >:: (fun _ -> assert_string "user1@10:  \nuser1@10: O Fortuna\nuser1@10: velut luna\nuser3@30: statu variabilis\nuser2@20: semper crescis\nuser1@10: aut decrescis;\nuser1@10: vita detestabilis\nuser2@20: nunc obdurat\nuser1@10: et tunc curat" 
        (Messaging.refresh_history_buffer user1 package10;
        Messaging.chat_history_to_string ()));
]
